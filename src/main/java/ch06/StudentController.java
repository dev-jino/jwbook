...
public class StudentController extends HttpServlet {
    StudentServiceDAO service;

    @Override
    public void init() throws ServletException {
        service = new StudentServiceDAO();
        service.open();
    }
    ...
    private String update(HttpServletRequest req, HttpServletResponse resp) {
        ...
        if (method.equals("GET")) {
            req.setAttribute("student", service.findById(req.getParameter("id")));
            return "studentForm.jsp";
        } else if (method.equals("POST")) {
            service.update(Integer.parseInt(req.getParameter("id")),
